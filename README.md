...
- 🔭 Я специализируюсь на создании **тестовых фреймворков с нуля**, интеграции тестов в CI/CD и обеспечении качества сложных веб-приложений.
...
<td width="50%">
  ...
  <a href="[ССЫЛКА_НА_РЕПО_1]">Посмотреть код</a>
</td>
<td width="50%">
  ...
  <a href="[ССЫЛКА_НА_РЕПО_2]">Посмотреть код</a>
</td>
</tr>
<tr>
<td width="50%">
  ...
  <a href="[ССЫЛКА_НА_РЕПО_3]">Посмотреть код</a>
</td>
<td width="50%">
  ...
  <!-- <a href="[ССЫЛКА_НА_РЕПО_4]">Посмотреть наработки</a> -->
