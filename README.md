<div align="center">
  <strong>Привет, меня зовут Саша!</strong>
  <br>
  <i>Я Java AQA Engineer / SDET</i>
</div>
<br>

Искренне люблю свою профессию за возможность применять инженерный подход к обеспечению качества. В настоящий момент работаю в FinTech сфере: поддерживаю, дорабатываю и пишу тесты на существующем тестовом BDD-фреймворк (Java + Playwright + Cucumber).

Мой главный профессиональный интерес — проектирование удобной и надежной тестовой архитектуры с нуля. В свободное время в качестве R&D я разрабатываю собственные модульные фреймворки, используя различные инструменты и паттерны автоматизации. Это помогает мне на практике тестировать новые подходы к автоматизации и глубже понимать работу инструментов.

Активно применяю AI-ассистентов для повышения продуктивности: от генерации тестовых данных и рефакторинга кода до написания документации.
...
<p align="left">
  ...
  <a href="https://gradle.org/"><img title="Gradle" alt="Gradle" src="https://raw.githubusercontent.com/LelouchFR/skill-icons/5401d691a2268d5a3ee6c3b3163c31b6a2a0be6d/assets/gradle-auto.svg" width="60" height="60"></a>
...
<p align="left">
  <strong>Автоматизация тестирования мобильных приложений:</strong><br>
