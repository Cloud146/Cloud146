...
Мой главный профессиональный интерес — архитектура тестовых решений. Постоянно изучаю новые паттерны проектирования и библиотеки. В качестве R&D разрабатываю собственный модульный фреймворк, чтобы тестировать современные подходы к автоматизации.
