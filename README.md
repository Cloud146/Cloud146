...
Активно применяю AI-ассистентов (ChatGPT, GitHub Copilot) для повышения продуктивности: от генерации тестовых данных и рефакторинга кода до написания документации.
